...
export const CopyWritingIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M19 3H5v2h14V3zm-2 4H7v2h10V7zm0 4H7v2h10v-2zm-6 4H7v2h4v-2zm6-9H5v14h14V6zm-2 12H7v-2h10v2z"/>
